INSERT INTO citation_datasource (id,name) VALUES (3,'IMPORTED');
...
ALTER TABLE imported_court_mapping ADD CONSTRAINT imported_court_mapping_fk_1 FOREIGN KEY (court_id) REFERENCES court (court_id);
